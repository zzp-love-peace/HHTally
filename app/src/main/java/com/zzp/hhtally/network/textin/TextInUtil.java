...
public class TextInUtil {
    ...
    private static final String appId = "030451c62bb1d44fb2389ad1636cc4b7";
    private static final String secretCode = "2d34835bf5b9c88d7aa25d71744d461b";
    ...
    public static String imgCropEnhance(byte[] imgData) {
        // 图片切边增强
    ...
    public static String imgDewarp(byte[] imgData) {
